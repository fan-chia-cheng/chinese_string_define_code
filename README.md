...
STEP4_Base與python_文字挖掘關鍵字(stop_words_M813-05_1004.txt)與STEP3_利用JSON&MySQL_尋找重複(雲端內的檔案夾)，
#6_EXCEL_關鍵字_比較並寫入新的user_dict在其他檔案.ipynb 
使用檔案為STEP4.2_SQL_工作項目及說明_總額計算(0815)_M810-01(參考前案，工作項目內容已經合併完成，寫入細目編碼與契約單價，預算金額也有)。
配合file_path='./userdict.txt'  #20241004更改後要先寫入
產生檔案為
SQL_工作項目及說明_總額計算.xlsx

***20241005_新加入生成user_dict從MDL1350001分字後，先用user_dict ver1去刪除後，再將未加入的新增編碼***
***MDL1350003因為總額結算過多(內容為細分化)故未加入編寫細項***
#7-1EXCEL資料copy到另一個EXCEL(最後1頁手動)，MDL1350003契約單價表的單價貼到報價單，方便製作契約單價=>契約單價表1118.xlsx。
